...
本套件为独立原创开发项目。所有技能文档、模板、脚本均为本项目独立撰写，未复制任何第三方技能包内容。本项目借鉴的是公开领域的合规方法论与工作流设计思路（如"法规核验""整改台账"等通用机制），此类方法论与功能设计不构成著作权法意义上的"表达"，不受著作权保护。

> 说明：本项目开发过程中参考了开源社区公开的 Agent Skill 设计模式，但全部文本内容为独立创作。文本相似度自查：与第三方公开技能包的最高文件相似度约 25%，无任何超过 50 字的连续相同文本段。
